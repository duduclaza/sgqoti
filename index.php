...
<body class="bg-gray-50 dark:bg-gray-900 font-sans transition-colors duration-300">
    ...
    <div class="flex min-h-screen">
        <!-- Menu Lateral Fixo -->
        <aside id="sidebar" class="fixed left-0 top-0 z-40 w-80 h-screen bg-white dark:bg-gray-800 shadow-xl border-r border-gray-200 dark:border-gray-700 flex flex-col transition-colors duration-300">
            <!-- Header do Menu -->
            <div class="flex items-center justify-center h-20 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-600 to-blue-700 dark:from-gray-700 dark:to-gray-800">
                <div class="text-center">
                    <h1 class="text-xl font-bold text-white dark:text-gray-100">SGQ OTI</h1>
        ...
        <main class="flex-1 ml-80">
            <!-- Header Superior -->
            <header class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 h-20 flex items-center justify-between px-8 transition-colors duration-300">
                <div>
                    <h2 id="page-title" class="text-2xl font-semibold text-gray-800 dark:text-gray-100">Controle de Toners</h2>
                    <p id="page-subtitle" class="text-sm text-gray-600 dark:text-gray-400">Gerencie o cadastro de toners e cartuchos</p>
                </div>
                <div class="flex items-center space-x-4">
                    <!-- Theme Toggle -->
                    <button id="theme-toggle" class="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 bg-white dark:bg-gray-800 transition-all duration-300 flex items-center gap-2 shadow-sm" title="Alternar tema">
                        <span id="theme-toggle-icon" aria-hidden="true">🌙</span>
                        <span id="theme-toggle-text" class="text-sm font-medium">Modo escuro</span>
                    </button>
                    <div class="text-right">
                        <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Usuário Logado</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400" id="current-date"></p>
                    </div>
                    <div class="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 rounded-full flex items-center justify-center shadow-lg">
            ...
            <!-- Conteúdo da Página -->
            <div class="p-8">
                <div id="content-area" class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
                    ...
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">Controle de Toners</h3>
                        <p class="text-gray-600 dark:text-gray-400">Selecione uma opção no menu lateral para começar</p>
                    </div>
                </div>
            </div>
        </main>
